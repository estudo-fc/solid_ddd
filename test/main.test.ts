...
import { ReservationRepositoryDatabase } from "../src/infra/repository/ReservationRepository";
...
beforeAll(() => {
    return new ReservationRepositoryDatabase().updateAllReservationStatus("cancel");
});
